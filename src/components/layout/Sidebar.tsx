...
export const Sidebar: React.FC = () => {
  ...
  return (
    <aside className="w-20 bg-dark-panel/30 backdrop-blur-xl border-r border-dark-border/30 h-screen sticky top-0 flex flex-col items-center py-6">
      ...
      {/* Sign Out Button */}
      <button onClick={handleSignOut} className="mt-2 w-14 h-14 rounded-2xl bg-dark-panel-hover border border-dark-border flex items-center justify-center text-slate-500 hover:text-red-400 hover:border-red-400/50 transition-all duration-300">
        <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
